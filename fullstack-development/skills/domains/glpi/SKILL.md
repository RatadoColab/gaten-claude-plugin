...
|---|---|
| Criar um novo plugin do zero | `domains/glpi/plugin-creation/SKILL.md` |
| Criar ou editar handlers em `ajax/` | `domains/glpi/ajax-handlers/SKILL.md` |
| Criar ou editar formulários Twig em `templates/` | `domains/glpi/form-templates/SKILL.md` |
| Adicionar interface Vue em templates Twig (aba/SPA no plugin) | `domains/glpi/vue/SKILL.md` |
