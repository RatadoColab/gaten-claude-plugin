...
- **Classes:** PascalCase, sem prefixo `Plugin` (ex.: `MeuItem`)
- **Arquivos de classe:** `src/MeuItem.php` (PascalCase, em `src/`)
...
- **Chave de permissão (`$rightname`):** `plugin_<nomeplugin>_<nomeitem>` (ex.: `plugin_meuplugin_meuitem`)
